...
// public static Usuarios [] ArregloUsu = new Usuarios [11];
    ...
    private void initComponents() {
        ...
        Guardar.setForeground(new java.awt.Color(34, 49, 64));
        ...
        for (int i = 0; i < ArregloUsu.length; i++) {
            if(ArregloUsu[i]!=null){
             if(ArregloUsu[i].getId() == eli ){
               ArregloUsu[i].setNombreUsuario(NombreCliente.getText());
               ArregloUsu[i].setApellidoUsuario(ApellidoCliente.getText());
